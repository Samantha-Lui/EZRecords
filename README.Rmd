...
* Class __*product_logs*__ : an S4 class representing a business transaction log
    ...
    | show_stock(obj, ...) |  extract the pertinent items' information for each item from each transaction record of the business log and return the result for further calculation of the stock status of product |
